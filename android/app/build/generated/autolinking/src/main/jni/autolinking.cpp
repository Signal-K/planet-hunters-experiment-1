...
#include <RTNGodotSpec.h>
#include <react/renderer/components/RTNGodotSpec/ComponentDescriptors.h>
...
auto module_RTNGodotSpec = RTNGodotSpec_ModuleProvider(moduleName, params);
if (module_RTNGodotSpec != nullptr) {
return module_RTNGodotSpec;
}
...
providerRegistry->add(concreteComponentDescriptorProvider<RTNGodotViewComponentDescriptor>());
