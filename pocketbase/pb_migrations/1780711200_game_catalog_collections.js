  ...
  try {
    ...
    app.save(new Collection({
      ...
      fields: [
        ...
        { type: 'select', name: 'scan_source',        maxSelect: 1, values: ['station', 'satellite', 'rover'] },
        { type: 'number', name: 'deposits_to_map' },
        { type: 'bool',   name: 'reveals_minerals' },
        { type: 'json',   name: 'reveals_landmarks',  maxSize: 1000 },
