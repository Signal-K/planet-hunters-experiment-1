...
updatedAt: '2026-05-13T08:07:45.791Z'
tags:
  - project-landnam
  - doc-kind-general
  - creative
...
| `2pqc1e` | Draft chapter outlines for Story Arc 2 | Arc 2 implementation |
...
| `8rv9kf` | Design arc-complete celebration moment | Reward moment UX |
...
| `ps6nfy` | Design the SR2 unlock celebration moment | SR2 celebration UX |
...
**Output format**: Short strings, max 1–2 lines per button/screen. For celebration moments, a brief spec (headline, sub-line, visual direction) is enough — engineering handles implementation.
