...
- [x] #2 A 'Mission Complete' moment plays after M1 debrief is resolved before survey triggers
...
<!-- SECTION:NOTES:BEGIN -->
AC1: full session arc complete (intro splash→tutorial→science transit→debrief science card→survey). AC2: Mission Complete moment added to MissionDebrief, auto-dismisses after 2.5s. AC3: FeedbackBeacon now applies PanelStyle (blue primary button). AC4: linear flow verified—no dead ends, tutorial always advances.
<!-- SECTION:NOTES:END -->
