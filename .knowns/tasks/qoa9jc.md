...
updatedAt: "2026-02-15T15:42:01Z"
timeSpent: 0
---
...
# Trigger in Experiment 1 to show Posthog survey, and tie to user id

We need to identify users based on their browser cookies or someth, maybe allow them to input a name, or even better - have it automaticall create a guest account in supabase and tie that to the posthog identifier. This is just for the react (deployed -> vercel) app for now
