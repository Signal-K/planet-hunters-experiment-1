...
updatedAt: '2026-04-25T00:50:00.118Z'
timeSpent: 0
assignee: '@me'
---
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Active mission card layout lives in a .tscn scene/template
- [ ] #2 Control station, scanner station, next mission, and star map cards use scene-owned layouts
- [ ] #3 earth_base_1.gd binds data into existing scene/template nodes instead of constructing those cards in code
- [ ] #4 Earth base unlock and structure tests cover the scene-owned card flow
<!-- AC:END -->
