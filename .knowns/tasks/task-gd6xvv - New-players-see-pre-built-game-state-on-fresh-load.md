...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 scene/rockets_state.json reset to blank default (no missions, no control station, 0 francs)
- [x] #2 scene/franc_balance.json reset to balance: 0
- [x] #3 scene/mission_logs.json reset to empty missions array
- [x] #4 scene/subcontractors.json reset to blank defaults
- [x] #5 Root franc_balance.json reset to balance: 0
