...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Landing page shows 'Distant Signals' as the game title
- [ ] #2 Tagline: 'Mine asteroids. Build settlements. Discover real planets.'
- [ ] #3 All React Native screens updated
- [ ] #4 Storage key names unchanged to preserve existing sessions
<!-- AC:END -->
