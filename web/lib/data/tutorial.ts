...
export const M1_STEPS: TutorialStep[] = [
  ...
  { id: 2, screen: 'missions', title: 'Select a Mission',
    body: 'Clients post contracts that fund your program. Each one names the ore to mine, the destination, the payment, and the client affinity you earn for finishing it.',
...
export const M2_STEPS: TutorialStep[] = [
  ...
  { id: 22, screen: 'missions', title: 'Choose Your Second Contract',
    body: 'You already know the loop: accept a client contract, choose a viable target, mine the order, then return for payment and affinity. Prospector lets you take the larger order.',
