...
export const CONTRACTOR_SLOTS: ContractorSlot[] = [
  {
    ...
    initial: 'HP',
    unlockTier: 1,
    projectType: 'Fuel logistics and orbital propellant reserves',
    mineralPreferences: ['hydrogen'],
    payoutPremium: 0.20,
    affinityBonusPerMission: 0.025,
    payoutNotes: '20% premium on hydrogen and propellant runs',
  ...
  },
  {
    ...
    initial: 'AB',
    unlockTier: 1,
    projectType: 'Energy storage manufacturing and cathode supply',
    mineralPreferences: ['cobalt', 'copper'],
    payoutPremium: 0.22,
    affinityBonusPerMission: 0.025,
    payoutNotes: '22% premium on cobalt and copper battery inputs',
  ...
  },
  {
    ...
    initial: 'FO',
    unlockTier: 1,
    projectType: 'In-space manufacturing and structural assembly',
    mineralPreferences: ['aluminium', 'copper'],
    payoutPremium: 0.18,
    affinityBonusPerMission: 0.02,
    payoutNotes: '18% premium on aluminium and copper construction cargo',
