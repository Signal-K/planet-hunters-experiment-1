...
import { CREW_MODULE_PRICE } from './economy'
...
export function getBuildSequence(missionsDone: number, crewModuleResearched = false): ShipRoomKind[] {
  if (missionsDone >= 6) return crewModuleResearched ? [...BUILD_SEQUENCES[4], 'crew-module'] : BUILD_SEQUENCES[4]
  if (missionsDone >= 4) return crewModuleResearched ? [...BUILD_SEQUENCES[3], 'crew-module'] : BUILD_SEQUENCES[3]
