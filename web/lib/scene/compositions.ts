...
export const EARTH_BASE_COURTYARD: SceneComposition = {
  ...
  bands: [
    ...
    },
    {
      ...
      scale: 2.4,
      bricks: [
        { brick: 'far_block', x: 22, scale: 1.8 },
        { brick: 'far_mast', x: 36, scale: 1.6 },
        { brick: 'far_block', x: 52, scale: 2.2 },
        { brick: 'far_dish', x: 70, scale: 2.0 },
        { brick: 'far_silo', x: 84, scale: 1.4 },
      ],
    },
    {
      id: 'treeline',
