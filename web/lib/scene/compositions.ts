  ...
  bands: [
    ...
    },
    {
      ...
      bricks: [
        ...
        { brick: 'mtn_shoulder', x: 14, scale: 0.9, flip: true },
        { brick: 'mtn_peak_tall', x: 26, scale: 0.86 },
        { brick: 'mtn_peak_broad', x: 44, scale: 0.94, flip: true },
        { brick: 'mtn_shoulder', x: 60, scale: 1.0 },
        { brick: 'mtn_peak_tall', x: 73, scale: 1.0, flip: true },
        { brick: 'mtn_peak_broad', x: 89, scale: 0.9 },
        { brick: 'mtn_shoulder', x: 101, scale: 0.85 },
      ],
    },
    {
      id: 'range-mid',
      ...
      bricks: [
        ...
        { brick: 'mtn_shoulder', x: 33, scale: 0.72, flip: true },
        { brick: 'mtn_peak_tall', x: 50, scale: 0.6 },
        { brick: 'mesa', x: 65, scale: 0.68 },
        { brick: 'mtn_shoulder', x: 82, scale: 0.78 },
        { brick: 'mesa', x: 96, scale: 0.72, flip: true },
      ],
    },
    {
  ...
  bands: [
    ...
    },
    {
      ...
      bricks: [
        ...
        { brick: 'mtn_peak_tall', x: 12, scale: 0.8 },
        { brick: 'mtn_shoulder', x: 30, scale: 0.85, flip: true },
        { brick: 'mtn_peak_broad', x: 48, scale: 0.85, flip: true },
        { brick: 'mtn_peak_tall', x: 68, scale: 0.9, flip: true },
        { brick: 'mtn_shoulder', x: 86, scale: 0.8 },
        { brick: 'mtn_peak_broad', x: 106, scale: 0.85 },
      ],
    },
    {
      id: 'hills-near',
