        ...
        <div style={{ position: 'absolute', inset: 0, paddingTop: hasCoach ? 184 : 128, paddingBottom: 120, overflowY: 'auto' }}>
          ...
          <div style={{ padding: '0 14px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {CATALOG.map(c => {
              ...
              return (
                <button key={c.id} onClick={() => c.avail && setPicked(c.id)} style={{ background: 'transparent', border: 'none', padding: 0, textAlign: 'left', cursor: c.avail ? 'pointer' : 'not-allowed', opacity: c.avail ? 1 : 0.5 }}>
