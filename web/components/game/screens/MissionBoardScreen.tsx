...
export default function MissionBoardScreen({ onBack, onPick, missionsDone, freeOperations, hasCoach, catalog, clientMissions, clientCooldowns, dailyClientPool, francs, crew = [], player }: MissionBoardScreenProps) {
  ...
  return (
    <div className="ln-scene-mission-board" style={{ width: '100%', height: '100%', position: 'relative', background: 'var(--ln-shell)' }}>
      ...
      <div className="mission-board-screen-content" data-ui-zone={UI_ZONES.screenContent} style={{ position: 'absolute', inset: 0, paddingTop: hasCoach ? TUTORIAL_CONTENT_TOP : 72, paddingBottom: hasCoach ? 176 : 112, overflowY: 'auto', scrollPaddingTop: hasCoach ? TUTORIAL_CONTENT_TOP : undefined }}>
