...
static var Level2UnlockOverlayScene: PackedScene = load("res://Scenes/UI/Templates/SatelliteLevel2UnlockOverlay.tscn") if ResourceLoader.exists("res://Scenes/UI/Templates/SatelliteLevel2UnlockOverlay.tscn") else null
static var UnlockItemScene: PackedScene = load("res://Scenes/UI/Templates/MenuUnlockItem.tscn") if ResourceLoader.exists("res://Scenes/UI/Templates/MenuUnlockItem.tscn") else null
