...
func _ready() -> void:
	...
	_connect("MenuButton", func(): _go(BASE_SCENE))
	_connect("LaunchpadButton", func(): _go(MISSIONS_SCENE))
	_connect("BuildLeftButton", func(): _go("res://Scenes/Earth/earth_base_1.tscn"))
	_connect("BuildRightButton", func(): _go("res://Scenes/Earth/earth_base_1.tscn"))
	_connect("MissionsButton", func(): _go(MISSIONS_SCENE))
	_connect("GalaxyButton", func(): _go(GALAXY_SCENE))
	_connect("FabButton", func(): _go(FAB_SCENE))
