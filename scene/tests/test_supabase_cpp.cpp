...
TEST_CASE("[Supabase/C++][Resource] SupabaseClient GDScript loads and instantiates") {
    print_line("\n==============================");
    print_line("🧪 C++ TEST: SupabaseClient GDScript loads and instantiates");
    print_line("==============================");
    ...
    print_line("Resource loaded, type is Script: " + itos(script.is_valid()));
    ...
    if (instance) {
        print_line("Instantiated SupabaseClient script instance");
    }
    ...
    if (instance) {
        ...
        print_line("Checking fetch_anomalies method availability");
