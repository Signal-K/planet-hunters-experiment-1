    ...
    <div className="scene" style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'auto' }}>
          ...
          {/* Satellite — left, set back on the tree line */}
          <Building
            kind="satellite"
            label="Satellite"
            sub="SCANNING"
            ...
            w={78}
            style={{ left: 16, top: 506 }}
          />

          {/* Launchpad — center, dominant, on the ground */}
          <Building
            kind="launchpad"
            label="Launchpad"
            ...
            w={132}
            style={{ left: '50%', top: 486, transform: 'translateX(-50%)' }}
          />
...
window.LandnamScreensPre = {
  HubScreen, MissionBoardScreen, TargetPickerScreen, FabScreen, GalaxyScreen, GameMenu,
};
