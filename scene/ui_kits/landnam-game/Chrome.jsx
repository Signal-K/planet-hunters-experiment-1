...
function Stage({ children, variant }) {
...
// ── Button ─────────────────────────────────────────────────────────────
function Button({ variant = 'primary', children, size = 'md', icon, onClick, style }) {
...
function TopBar({ title, eyebrow, right, level, francs }) {
  return (
    <div style={{
...
function Seg({ check, label, color, last }) {
...
Object.assign(window, { Stage, Button, TopBar, BottomBar, Seg });
